      ...
      return searchResults.map((el: any) => {
        ...
        return (
            txtIndex >= 0 ? <>
                ...
                <span className="searchCategory desktop-down">
                    {el.category}
                </span>
        ...
        //   question:
        //     txtIndex >= 0
        //       ? <span class="searchResult">${el.question.slice(0, txtIndex)}<span class="boldText">${el.question.slice(
        //           txtIndex,
        //           txtIndex + txtLenght
        //         )}</span>${el.question.slice(txtIndex + txtLenght)} -</span>
        //   <span class="searchCategory desktop-down"> ${
        //     el.category
        //   }</span></span> <span class="searchCategory desktop-up">${el.category}</span>`
        //       : `<span class="searchResult">${el.question} -</span>
        //   <span class="searchCategory desktop-down"> ${el.category}</span></span> <span class="searchCategory desktop-up">${el.category}</span>`,
        // }
      })
    };
